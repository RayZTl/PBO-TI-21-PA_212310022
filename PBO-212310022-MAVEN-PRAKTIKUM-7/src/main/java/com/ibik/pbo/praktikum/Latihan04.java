...
public class Latihan04 extends JFrame implements ActionListener {
    ...
    private void GenerateForm(Latihan04 frameForm) {
        ...
        title_form.setFont(new Font("Arial", Font.PLAIN, 15));
        title_form.setBounds(40, 40, 300, 12);
        ...
        final String data[][] = {{"212310022", "Raynaldi Rizky Aditya", "B"}, 
        					{"212310043", "MUHAMMAD ANGGA PARULIAN HARAHAP", "A"},
                            {"212310011", "MUHAMMAD FAUZAN RINDU MAULANA", "A"}};
